...
sig_iq = filt(shifted_to_zero_complex_sig, Fc=0.2, NFIR=101)
...
sig_iq_decim = decimate(sig_iq, DECIM_ORDER=6, NFIR=101)
...
demod_sig_decim = decimate(demod_sig, DECIM_ORDER=10, NFIR=101)
