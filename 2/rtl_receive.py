...
class rtl_receive(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "rtl_receive")
        ...
        # Blocks
        ##################################################
        self._rx_gain_range = Range(1, 45, 1, 20, 200)
        ...
        self._freq_range = Range(80, 110, 0.1, 100, 200)
...
def main(top_block_cls=rtl_receive, options=None):
